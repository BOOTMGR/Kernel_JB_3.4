...
*/
	...
	if (machine_is_msm7x30_fluid()) {
		rc = pm8xxx_gpio_config(PMIC_GPIO_SDC4_EN, &sdc4_en);
		if (rc) {
...
static int pm8058_pwm_config(struct pwm_device *pwm, int ch, int on)
{
	...
	case 2:
		if (on) {
			id = 24 + ch;
			rc = pm8xxx_gpio_config(id - 1, &pwm_gpio_config);
			if (rc)
...
*/
static struct pm8xxx_gpio_platform_data pm8058_gpio_data = {
	.gpio_base	= PM8058_GPIO_PM_TO_SYS(0),
//	.irq_base	= PM8058_GPIO_IRQ(PMIC8058_IRQ_BASE, 0),
	.init		= pm8058_gpios_init,
};

static struct pm8xxx_mpp_platform_data pm8058_mpp_data = {
...
//	.irq_pdata		= &pm8xxx_irq_pdata,
	.gpio_pdata		= &pm8058_gpio_data,
	.mpp_pdata		= &pm8058_mpp_data,
...
static void __init pmic8058_leds_init(void)
{
	...
	pm8058_7x30_data.sub_devices[PM8058_SUBDEV_LED].pdata_size
